...
/* SKL/KBL ROM status/error messages */
#define SKL_DSP_ROM_INIT                0x0
#define SKL_DSP_ROM_INIT_DONE           0x1
#define SKL_DSP_ROM_MEM_PWR_DONE        0x2
#define SKL_DSP_ROM_MANIFEST_LOADED     0x3
#define SKL_DSP_ROM_MANIFEST_VERIFIED   0x4
#define SKL_DSP_ROM_FEAT_MASK_VERIFIED  0x5
#define SKL_DSP_ROM_BASEFW_FOUND        0x6
#define SKL_DSP_ROM_BASEFW_BA_VALID     0x7
#define SKL_DSP_ROM_BASEFW_TOTAL_PWR    0x8
#define SKL_DSP_ROM_BASEFW_TEXT_LOADED  0x9
#define SKL_DSP_ROM_BASEFW_TEXT_HASHED  0xa
#define SKL_DSP_ROM_BASEFW_RODA_LOADED  0xb
#define SKL_DSP_ROM_BASEFW_RODA_HASHED  0xc
#define SKL_DSP_ROM_BASEFW_HASH_VER     0xd
#define SKL_DSP_ROM_BASEFW_START_FOUND  0xe
#define SKL_DSP_ROM_BASEFW_ENTERED      0xf
#define SKL_DSP_ROM_SKL_STS_MASK		GENMASK(16, 0)
#define SKL_DSP_ROM_ERROR		0x80001000
